@section('select_teacher_form')
  @if(isset($candidate_teachers) && count($candidate_teachers) > 0 && $select_lesson<1)
  ...
  <ul class="mailbox-attachments clearfix row">
    ...
    <?php $teacher = $teacher->user->details()
    ?>
    <li class="col-6" accesskey="" target="">
      @component('trials.forms.charge_teacher', ['teacher' => $item->_candidate_teachers($teacher->id, $calendar->lesson(true))[0],  'attributes' => $attributes, 'user' => $user, 'domain' => $domain, 'domain_name' => $domain_name])
        @slot('addon')
        <div class="col-12 mb-2">
