        ...
        <div class="inner">
          ...
          <div id="m1" class="panel-collapse in collapse show" style="">
            ...
            <span class="float-right mr-1">
              <a href="javascript:void(0);" page_title="目標編集" page_form="dialog" page_url="/milestones/{{$milestone->id}}/edit?origin={{$domain}}&item_id={{$item->id}}" role="button" class="btn btn-default btn-sm float-left mr-1">
                <i class="fa fa-edit"></i>
              </a>
              <a href="javascript:void(0);" page_title="目標削除" page_form="dialog" page_url="/milestones/{{$milestone->id}}?origin={{$domain}}&item_id={{$item->id}}&action=delete" role="button" class="btn btn-default btn-sm float-left mr-1">
