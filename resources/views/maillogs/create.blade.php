    ...
    <div class="row">
      <div class="col-12">
        <div class="form-group">
          ...
          <input type="text" name="subject" class="form-control" required="true" maxlength=50
          @if(isset($_edit) && $_edit==true)
           value="{{$item['subject']}}" placeholder="(変更前) {{$item['subject']}}">
          @else
           placeholder="50文字まで">
          @endif
        </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="form-group">
          ...
          <textarea type="text" id="body" name="body" class="form-control" required="true"  maxlength=5000
          @if(isset($_edit) && $_edit==true)
