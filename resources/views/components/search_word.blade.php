<div class="input-group mb-3">
  <input type="text" name="search_word" class="form-control" placeholder="{{__('labels.search_keyword')}}" value="{{(rawurldecode(urlencode($search_word)))}}" style="width:140px;" accesskey="keyword_search">
