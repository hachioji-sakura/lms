...
@section('list_filter')
  ...
  @component('components.list_filter', ['filter' => $filter, '_page' => $_page, '_line' => $_line, 'domain' => $domain, 'domain_name' => $domain_name, 'attributes'=>$attributes])
    ...
    @component('textbooks.select_form', ['prefix'=>'search_','textbook'=> $textbook??null,'collection' => $suppliers ,'target_item' =>'publisher']); @endcomponent
    @component('textbooks.select_form', ['prefix'=>'search_','textbook'=> $textbook??null,'collection' => $suppliers ,'target_item' =>'supplier']); @endcomponent
