@section('first_form')
  <div class="row">
    ...
    @component('textbooks.forms.select_publisher', ['prefix'=>'','textbook'=> $textbook??null,'publishers' => $publishers]); @endcomponent
    @component('textbooks.forms.select_supplier', ['prefix'=>'','textbook'=> $textbook??null,'suppliers' => $suppliers]); @endcomponent
