@section('first_form')
  <div class="row">
    ...
    @component('textbooks.forms.subject', ['_edit'=>$_edit,'textbook'=> $textbook??null,'subjects' => $subjects,'textbook_subjects' => $textbook->subject_list??null]); @endcomponent
    @component('textbooks.forms.grade', ['_edit'=>$_edit,'grades' => $grades,'textbook_grades' => $textbook->grade_list??null]); @endcomponent
