@section('first_form')
  <div class="row">
    @if($item->work!=9)
      ...
      @component('textbooks.forms.select_difficulty', ['_edit' => $_edit,]); @endcomponent
...
{{--          <span class="right badge badge-secondary ml-1">{{__('labels.optional')}}</span>--}}
{{--        </label>--}}
{{--        <textarea type="text" id="body" name="remark" class="forms-control" placeholder="例：ミーティング" >@if($_edit==true){{$item->remark}}@endif</textarea>--}}
{{--      </div>--}}
{{--    </div>--}}
{{--  </div>--}}
{{--@endsection--}}
