...
<div class="row">
  ...
  <div class="col-12">
    <div id="test" class="form-group">
      ...
      <select name="birth_day_year" class="form-control select2 float-left mr-1" width="25%"  accessKey="year" placeholder="生年月日(年)" >
      </select>
      <select name="birth_day_month" class="form-control select2 float-left mr-1" width="20%"  accessKey="month" placeholder="生年月日(月)" >
      </select>
      <select name="birth_day_day" class="form-control select2 float-left" width="20%" accessKey="day" placeholder="生年月日(日)">
      </select>
