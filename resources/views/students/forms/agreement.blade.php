<section id="member" class="content-header">
	<div class="container-fluid">
        ...
        <div class="row bd-b bd-gray my-2">
          <div class="col-12 font-weight-bold" >
              <i class="fa fa-user-graduate mr-1"></i>
              生徒様情報
          </div>
        </div>
        <div class="row bd-r bd-gray">
        ...
        <div class="row bd-b bd-gray my-2">
          ...
          @foreach($item->user->calendar_setting() as $schedule_method => $d1)
					<div class="row bd-r bd-gray bd-b bd-gray">
            @foreach($d1 as $lesson_week => $settings)
              @foreach($settings as $setting)
              <?php
              $setting = $setting->details();
              ?>
              <div class="col-12 p-2 font-weight-bold" >{{$setting->lesson()}} / {{$setting->course()}}</div>
              <div class="col-12 col-md-6 p-2 pl-4" >
                ・曜日/時間：
                {{$setting->schedule_method()}}
