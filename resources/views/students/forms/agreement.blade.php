	    ...
	    <div class="card-body">
				<div class="row">
					<div class="col-6 col-md-3 p-2 font-weight-bold" >氏名</div>
					...
					<div class="col-6 col-md-3 p-2 font-weight-bold" >生年月日</div>
					<div class="col-6 col-md-3 p-2">{{$item->birth_day()}}</div>
					<div class="col-6 col-md-3 p-2 font-weight-bold" >学年</div>
					<div class="col-6 col-md-3 p-2">{{$item->grade()}}</div>
					<div class="col-6 col-md-3 p-2 font-weight-bold school_name_confirm" >学校名</div>
					<div class="col-6 col-md-3 p-2">{{$item->school_name()}}</div>
          <div class="col-6 col-md-3 p-2 font-weight-bold" >レッスン</div>
          <div class="col-6 col-md-3 p-2">{{$item->tags_name('lesson')}}</div>
          <div class="col-6 col-md-3 p-2 font-weight-bold" >通塾回数/週</div>
          <div class="col-6 col-md-3 p-2">週{{$item->tag_value('lesson_week_count')}}回</div>
          <div class="col-6 col-md-3 p-2 font-weight-bold" >授業時間</div>
          <div class="col-6 col-md-3 p-2">{{$item->tag_name('course_minutes')}}</div>
          @if($item->user->has_tag('lesson',2)==true)
          <div class="col-6 col-md-3 p-2 font-weight-bold" >英会話コース</div>
          <div class="col-6 col-md-3 p-2">{{$item->tag_name('english_talk_course_type')}}</div>
          @endif
          @if($item->user->has_tag('lesson',4)==true)
          <div class="col-6 col-md-3 p-2 font-weight-bold" >習い事コース</div>
          <div class="col-6 col-md-3 p-2">{{$item->tag_name('kids_lesson_course_type')}}</div>
          @endif
					<div class="col-12 bd-b bd-gray"></div>
					<div class="col-6 col-md-3 p-2 font-weight-bold" >入会金</div>
          <div class="col-6 col-md-3 p-2">
					...
					<div class="col-6 col-md-3 p-2 font-weight-bold" >月会費</div>
          <div class="col-6 col-md-3 p-2">
