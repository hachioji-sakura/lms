    ...
    <div class="card-body">
          ...
          <div class="col-6 p-2">{{$item->school_name()}}</div>
	          ...
	          <div class="col-6 p-2">週{{$agreement->agreement_statements->where('lesson_id',$i)->first()->lesson_week_count}}回</div>
					...
					<div class="col-6 p-2">
						<input name="agreements[entry_fee]" class="form-control w-50 float-left" value="{{$agreement->entry_fee}}"><span class="ml-2 float-left mt-2">円(税込み)</span>
          </div>
					<div class="col-6 p-2 font-weight-bold" >月会費</div>
          <div class="col-6 p-2">
						<input name="agreements[monthly_fee]" class="form-control w-50 float-left" value="{{$agreement->monthly_fee}}"><span class="ml-2 float-left mt-2">円(税込み)</span>
          </div>
					@else
					<div class="col-6 p-2 font-weight-bold" >入会金</div>
          <div class="col-6 p-2">
