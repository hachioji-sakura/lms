                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-4 col-md-4 text-sm mt-1">
                    ...
                    @if($calendar["status"]==="fix" && date('Ymd', strtotime($calendar["start_time"])) === date('Ymd'))
                      <a title="{{$calendar["id"]}}" href="javascript:void(0);" page_title="出欠を取る" page_form="dialog" page_url="/calendars/{{$calendar["id"]}}/presence?_page_origin={{$domain}}_{{$item->id}}_calendar&mode=list" role="button" class="btn btn-info btn-sm w-100 mt-1">
