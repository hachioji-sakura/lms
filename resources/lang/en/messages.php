...
return [
 ...
 "confirm_calendar_fix" => "Do you want to confirm this schedule?",
 ...
 "confirm_calendar_confirm_for_teacher" => "Do you want to send a confirmation email for the following schedule?",
 "confirm_calendar_cancel" => "Cancel the following schedule?",
 "info_calendar_confirm" => "Please confirm the following schedule",
 ...
 "info_change_calendar" => "Please check the schedule change",
 "info_calendar_remind1" => "We have notified the students of the following schedule.",
 "info_calendar_remind2" => "After the decision operation of the schedule from the students,\nThe schedule will be finalized.",
 "warning_calendar_presence" => "Please have attendance for the following schedule",
 ...
 "info_teacher_change_send" => "We have sent a Email to substitute teacher",
 "info_teacher_change1" => "We have notified you of the following scheduled requests.",
 ...
 "error_work_record" => "We can not confirm monthly attendance because there are still schedule",
 ...
 "confirm_ask_remind" => "Would you like to resend this request?",
 ...
 "info_calendar_delete" => "This schedule has been deleted.",
 "info_calendar_add" => "We have added a :trialSchedule.",
 "info_calendar_update" => "We changed the :trialSchedule.",
 "info_calendar_setting_delete" => "The following repeat schedule has been deleted.",
 "info_calendar_setting_add" => "We have added a repeat :trialSchedule",
 "info_calendar_setting_update" => "Calendar Setting has been changed.",
 "info_regular_lesson_setting_update" => "Regular schedule has been changed.",
 "info_login_confirm" => "Please log in to my page and check.",
 "info_month_work_fix" => "The work records have been finalized.",
 "info_calendar_rest_proxy" => "I made a contact for the following schedule.",
 "info_calendar_rest" => "Mr./Ms.:user_name, I received a notification from the following schedule.",
 "info_calendar_rest_to_cancel" => "Also, this schedule will be canceled.\nThank you very much.",
 "info_calendar_rest_to_fix" => "Please continue your favors toward the students who will attend.",
 ...
 "info_calendar_cancel" => "The following schedule have been canceled.",
 ...
 "info_lecture_cancel" => "I have notified of the following schedule cancellation requests.\nAfter approving the request, it will be canceled.",
 'info_rest_cancel' => "The following cancellation request has been registered.\nPlease operate approval or send back on the request screen",
 'mail_title_until_today' =>  '【Action Required: Until today】',
 ...
 'ex_emergency_lecture_cancel' => "ex.Today ’s schedule will be canceled due to a cold.",
 'ex_late_arrival_reason' => "ex.Because of the train delay",
 "info_late_arrival" => "The student contacted us,\nThey was late for the following schedule\nThey arrive at :to_time_slot.",
 "info_late_arrival_cancel" => "The student contacted us,\nThey canceled the late contact for the following schedule.",
 ...
 "error_user_calendar_settings_not_during_enabel_date" => "This setting is not during of enable date",
 ...
 "task_title" => ":user_name registered learning record(:task_type)",
 ...
 'warning_schedule_add' => 'This additional requires an additional tuition fee and must be approved by the parent.',
 ...
 'please_register' => "Please register :target",
