...
return [
  ...
  "error_exchange_target" => "振替対象の予定を選択してください",
  ...
  "info_calendar_to_fix" => "生徒の予定を確定します。",
  "confirm_calendar_confirm" => "この予定を確定しますか？",
  "confirm_calendar_confirm_for_teacher" => "以下の予定を担当講師あてに連絡しますか？",
  "confirm_calendar_cancel" => "以下の予定をキャンセルしますか？",
  "info_calendar_confirm" => "以下の予定をご確認ください",
  ...
  "error_work_record" => "予定がまだ残っているため、月次勤怠の確定はできません",
  ...
  "trial_entry1" => "体験授業お申し込みいただきまして、\n誠にありがとうございます。",
  "trial_entry2" => "２営業日以内に、当塾よりご連絡いたしますので、\n何卒宜しくお願い致します。",
  "info_calendar_delete" => "予定が削除されました。",
  "info_calendar_add" => ":trial予定を追加いたしました。",
  "info_calendar_update" => ":trial予定を変更いたしました。",
  "info_calendar_setting_delete" => "繰り返し予定が削除されました。",
  "info_calendar_setting_add" => "繰り返し予定の承認をお願いします。",
  ...
  "info_calendar_rest_proxy" => "以下の 予定のお休み連絡をしました。",
  "info_calendar_rest" => ":user_name様より、以下の 予定のお休み連絡をいただきました。",
  "info_calendar_rest_to_cancel" => "また、この予定は休講となりますので、\n何卒、よろしくお願いいたします。",
  "info_calendar_rest_to_fix" => "引き続き、出席予定の生徒様への予定をよろしくお願いいたします。",
  ...
  "info_calendar_cancel" => "以下の予定は、キャンセルとなりました。",
  "info_lecture_cancel_to_cancel" => "以下の休講依頼について\n承認されませんでした。",
  "info_lecture_cancel_to_commit" => "以下の休講依頼について\n承認されました。",
  "info_lecture_cancel" => "以下の 予定の休講依頼を連絡しました。\n依頼承認後、休講となります。",
  'info_rest_cancel' => "以下の 予定の休み取り消し依頼が登録されました。\n依頼画面にて、承認もしくは、差戻しを操作してください",
  ...
  "message_trial_candidate_date1" => "お申込みいただいた体験予定につきまして、\nご希望の日時にて、体験予定を組むことができず、\n大変申し訳ございません。",
  ...
  'warning_schedule_add' => 'この予定追加は、受講料の追加を伴うため、親御様の承認を得る必要があります。',
