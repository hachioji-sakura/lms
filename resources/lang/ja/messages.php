...
return [
  ...
  'warning_unsubscribe' => "退会すると、システムへのログインができなくなります。\nまた、退会日以降の授業予定はすべて自動的にキャンセルとなります。",
  'confirm_unsubscribe' => "退会依頼を送信しますか？",
  'warning_recess' => "休会日以降の授業予定はすべて自動的にキャンセルとなります。",
  'warning_recess2' => "休会から再開する場合は、本システムにログインし、再開依頼を行ってください。\nまた、再開時については、現在の通塾予定にて授業予定を登録します。\n再開時点で講師の予定が合わない場合、再度調整となります。",
  'confirm_recess' => "休会依頼を送信しますか？",
  'warning_resume' => "休会から再開すると、現在の通塾予定にて授業予定を登録します。\n再開時点で講師の予定が合わない場合、再度調整となります。",
  'confirm_resume' => "再開依頼を送信しますか？",
];
