...
class CreateCommonStudentGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_common')->create('student_groups', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::connection('mysql_common')->dropIfExists('student_groups');
    }
}
