...
class CreateCommonTeachersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_common')->create('teachers', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::connection('mysql_common')->dropIfExists('teachers');
    }
}
