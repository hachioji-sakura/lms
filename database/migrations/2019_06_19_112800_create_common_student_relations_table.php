...
class CreateCommonStudentRelationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_common')->create('student_relations', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::connection('mysql_common')->dropIfExists('student_relations');
    }
}
