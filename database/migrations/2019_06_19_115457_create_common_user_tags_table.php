...
class CreateCommonUserTagsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_common')->create('user_tags', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::connection('mysql_common')->dropIfExists('user_tags');
    }
}
